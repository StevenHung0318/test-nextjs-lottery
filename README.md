...
[Example App on IPFS here!](ipfs://bafybeienqy65cyxk6ns7cifv3x7svcjkqktfixf6utn7ti62renm7tv3zu/)
...
```
git clone https://github.com/StevenHung0318/nextjs-smartcontract-lottery
...
```
git clone https://github.com/StevenHung0318/hardhat-smartcontract-lottery
cd hardhat-smartcontract-lottery
yarn 
yarn hardhat node
```

> You can read more about how to use that repo from its [README.md](https://github.com/StevenHung0318/hardhat-smartcontract-lottery/blob/main/README.md)
